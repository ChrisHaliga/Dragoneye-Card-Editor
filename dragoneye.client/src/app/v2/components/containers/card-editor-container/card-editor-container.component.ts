...
import { DeleteConfirmationModalV2Component } from '../../ui/delete-confirmation-modal/delete-confirmation-modal.component';
...
export class CardEditorContainerComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  @ViewChild(DeleteConfirmationModalV2Component) deleteModal!: DeleteConfirmationModalV2Component;
